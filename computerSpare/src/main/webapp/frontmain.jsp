...
<body>
    ...
    <div id="mobile-menu-offcanvas" class="offcanvas offcanvas-rightside offcanvas-mobile-menu-section">
        ...
        <div class="offcanvas-mobile-menu-wrapper">
            ...
            <div class="mobile-contact-info">
                <div class="h3">
                    <a href="index.html">Zero Arts</a>
                </div>

                <address class="address">
                    <span>Address :- Kotalawala , Kaduwela ,Colombo</span>
                    <span>Call Us: 045 46 46 596</span>
                    <span>Email:- Zeroartslk@gmail.com</span>
                </address>
    ...
    <div id="offcanvas-about" class="offcanvas offcanvas-rightside offcanvas-mobile-about-section">
        ...
        <div class="mobile-contact-info">
            ...
            <ul class="user-link">
                <li><a href="AddCard.jsp">Add Card</a></li>
                <li><a href="CarddetailsServlet">View My Cards</a></li>
                <li><a href="checkout.html">Checkout</a></li>
                <li><a href="FeedbackdetailsServlet">View My Feedback</a></li>
            </ul>
        </div>
        <!-- End Mobile contact Info -->
    </div> <!-- ...:::: End Offcanvas Mobile Menu Section:::... -->
            ...
            <ul class="offcanvas-cart">
                <li class="offcanvas-cart-item-single">
                    <div class="offcanvas-cart-item-block">
                        ...
                        <div class="offcanvas-cart-item-content">
                            <a href="#" class="offcanvas-cart-item-link">Keyboard</a>
                ...
                <li class="offcanvas-cart-item-single">
                    <div class="offcanvas-cart-item-block">
                        ...
                        <div class="offcanvas-cart-item-content">
                            <a href="#" class="offcanvas-cart-item-link">Monitor</a>
                            <div class="offcanvas-cart-item-details">
                ...
                <li class="offcanvas-cart-item-single">
                    <div class="offcanvas-cart-item-block">
                        ...
                        <div class="offcanvas-cart-item-content">
                            <a href="#" class="offcanvas-cart-item-link">Mouse</a>
                            <div class="offcanvas-cart-item-details">
                                <span class="offcanvas-cart-item-details-quantity">1 x </span>
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <div class="hero-slider-content">
                                        <h4 class="subtitle">Best For You </h4>
                                        <h2 class="title">Premium quality  <br> Products <br> Services</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="service-promo-single-item" data-aos="fade-up" data-aos-delay="0">
                            ...
                            <div class="content">
                                <h6 class="title">SAFE SHIPPING</h6>
                                <p>100 % Safe Shipping With Premium quality Curiour Services!</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="service-promo-single-item" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="content">
                                <h6 class="title">7 DAYS MONEY BACK</h6>
                                <p>100% satisfaction guaranteed, or get your money back within 7 days!</p>
                            </div>
                        </div>
                    </div>
                    <!-- End Service Promo Single Item -->
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="service-promo-single-item" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="content">
                                ...
                                <p>Pay After Product Will Recived.Check And Pay!</p>
                            </div>
                        </div>
                    </div>
                    <!-- End Service Promo Single Item -->
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="service-promo-single-item" data-aos="fade-up" data-aos-delay="600">
                            ...
                            <div class="content">
                                <h6 class="title">Good quality Products & Services</h6>
                                <p>We Sell Only AAA Quality Products & Services For Our Customers.</p>
                            </div>
                        </div>
                    </div>
                    <!-- End Service Promo Single Item -->
                            ...
                            <div class="swiper-container product-default-slider-4grid-1row">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        <div class="image-box">
                                            <a href="shop-full-width.html" class="image-link">
                                            ...
                                            <div class="action-link">
                                                ...
                                                <div class="action-link-right">
                                                    <a href="shop-full-width.html" data-bs-toggle="modal"
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="shop-full-width.html"> Monitor
                                                        </a></h6>
                                    ...
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="shop-full-width.html">Mouse
                                                         </a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="shop-full-width.html">Gaming KeyBoard
                                                        </a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                    ...
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="shop-full-width.html">Desktop Casing 
                                                        </a></h6>
                                                <ul class="review-star">
                                                    <li class="fill"><i class="ion-android-star"></i></li>
                                                    <li class="fill"><i class="ion-android-star"></i></li>
