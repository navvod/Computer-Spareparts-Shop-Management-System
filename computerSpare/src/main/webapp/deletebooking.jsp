...
<body>
    ...
    <form action="DeleteBookingServlet" method="post" class="container mt-4">
        <div class="col-md-8">
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <input type="text" name="destination" value="<%= destination %>" readonly class="form-control">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <input type="text" name="request" value="<%= requests %>" readonly class="form-control">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
