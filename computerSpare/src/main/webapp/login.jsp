                            ...
                            <div class="main-menu menu-color--black menu-hover-color--golden">
                                <nav>
                                    <ul>
                                        ...
                                        <li class="has-dropdown">
                                            <a class="active main-menu-link" href="index.html">Other Pages <i
                                                    class="fa fa-angle-down"></i></a>
                                            <!-- Sub Menu -->
                                            <ul class="sub-menu">
                                                <li><a href="cart.html">Cart</a></li>
...
<form action="LoginServlet" method="post">
    ...
    <div class="login_submit">
        <button type="submit" class="btn btn-md btn-black-default-hover mb-4">Login</button>
    ...
    <div class="login_submit">
        <h4>Register Now !</h4>
        <a href="REGISTER.html" button class="btn btn-md btn-black-default-hover mb-4">If You Don't Have An Account</button></a>
    </div>
</form>
                        ...
                        <div class="footer-widget-single-item footer-widget-color--golden" data-aos="fade-up"
                            ...
                            <div class="footer-about">
                                ...
                                <address class="address">
                                    ...
                                    <span>Email: NextSpare@gmail.com</span>
                                </address>
                            </div>
                        </div>
                        <!-- End Footer Single Item -->
