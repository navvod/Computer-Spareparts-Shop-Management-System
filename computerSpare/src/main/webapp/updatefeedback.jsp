...
<form action="UpdateFeedbackServlet" method="post" class="container mt-4">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-9 text-secondary">
                    <input type="text" name="feedbacks" value="<%= feedbacks %>" class="form-control">
                </div>
            </div>
            <hr>
        </div>
        <div class="card-footer">
            <input type="submit" name="submit" class="btn btn-info" value="Update My Feedback">
        </div>
    </div>
</form>
